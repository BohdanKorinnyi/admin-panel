...
public class BuyerDaoImpl implements BuyerDao {
    ...
    private static final String UPDATE_BUYER = "UPDATE buyers " +
            "SET name = ?, type = ?, comment = ?, plan_rev = ?, plan_profit = ?, plan_rev_old = ?, plan_profit_old = ? WHERE id = ?;";
    ...
    public void saveBuyers(List<Buyer> buyers) {
        jdbcTemplate.batchUpdate(INSERT_BUYER, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement preparedStatement, int i) throws SQLException {
                ...
                preparedStatement.setInt(3, buyers.get(i).getPlanRev());
                preparedStatement.setInt(4, buyers.get(i).getPlanProfit());
                preparedStatement.setInt(5, buyers.get(i).getPlanRevOld());
                preparedStatement.setInt(6, buyers.get(i).getPlanProfitOld());
            }
    ...
    public void updateBuyers(List<Buyer> buyers) {
        jdbcTemplate.batchUpdate(UPDATE_BUYER, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement preparedStatement, int i) throws SQLException {
                ...
                preparedStatement.setInt(5, buyers.get(i).getPlanRevOld());
                preparedStatement.setInt(6, buyers.get(i).getPlanProfitOld());
                preparedStatement.setLong(7, buyers.get(i).getId());
            }
