...
FROM (SELECT
      ...
      UNION (SELECT
             ...
             WHERE source_statistics.spent != 0
      ...
      UNION (
        ...
        WHERE source_statistics_today.spent != 0
      ...
      UNION (
        ...
        WHERE adv_status.real_status = 'approved' AND postback.status = adv_status.name AND postback.sum != 0
